...
#' \describe{
#'   \item{\code{\bold{years}}}{Integer vector of year values}
#'   \item{\code{\bold{month}}}{Integer vector of month values}
...
#'      \item{\code{\bold{case_norm}}}{Numeric vector of the normalized case
